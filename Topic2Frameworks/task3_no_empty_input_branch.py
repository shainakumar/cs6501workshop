...
def create_graph(llm):
    ...
    #   - verbose: Set to True if user typed "verbose", False if "quiet", unchanged otherwise
    ...
    def get_user_input(state: AgentState) -> dict:
        ...
        if user_input.lower() in ['quit', 'exit', 'q']:
            ...
            return {
                ...
                "verbose": verbose,   # keep current setting
            }
    ...
    def call_llm(state: AgentState) -> dict:
        ...
        if verbose:
            ...
            print(f"[TRACE] Input to LLM: '{user_input}'")
    ...
    def route_after_input(state: AgentState) -> str:
        ...
        Examines state:
            ...
            - user_input: Check if it's a mode toggle command
            - verbose: For tracing output

        Returns:
            - "__end__": If user wants to quit
            - "call_llm": If user provided input for the LLM
            - "get_user_input": If user toggled verbose/quiet mode (loop back immediately)
        """
        verbose = state.get("verbose", False)
        ...
        # Check if user toggled verbose/quiet mode - skip LLM and loop back
        user_input = state.get("user_input", "")
        if user_input.lower() in ['verbose', 'quiet']:
            if verbose:
                print("[TRACE] Mode toggle command detected, routing back to: get_user_input")
            return "get_user_input"

        # If get_user_input indicated reprompt (empty input), route back to prompt
    ...
    graph_builder.add_conditional_edges(
        ...
        {
            "call_llm": "call_llm",          # Regular input -> proceed to LLM
            "get_user_input": "get_user_input",  # Mode toggle/Empty Input -> loop back immediately
...
def main():
    ...
    initial_state: AgentState = {
        ...
        "should_exit": False,
        "llm_response": "",
        "verbose": False,  # Start in quiet mode by default
        "reprompt": False 
    }
